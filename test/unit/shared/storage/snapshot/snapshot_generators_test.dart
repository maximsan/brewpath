...
// The merge laws only say something if two generated snapshots overlap: union,
// max and last-writer-wins are trivially satisfied by values that never meet.
// Ids and days come from tiny pools for that reason, and activity entries have
// to as well — minting real tokens would make every entry globally unique and
// quietly hollow out the property tests over that field.
void main() {
