...
const DUEL_QUESTIONS = {
  basics: [
    { q: 'What part of the coffee plant do we actually brew?',
      choices: [{ t: 'The leaf' }, { t: 'The seed', correct: true }, { t: 'The root' }, { t: 'The flower' }],
    ...
    { q: 'Which species is sweeter, more aromatic and more delicate?',
      choices: [{ t: 'Robusta' }, { t: 'Arabica', correct: true }, { t: 'Liberica' }, { t: 'Excelsa' }],
      explain: 'Arabica grows high and cool. It’s most specialty coffee — and more fragile.' },
    { q: 'Coffee grows in a band around the…',
      choices: [{ t: 'Coastline' }, { t: 'Equator', correct: true }, { t: 'Poles' }, { t: 'Desert' }],
    ...
    { q: 'Robusta has, versus Arabica, roughly…',
      choices: [{ t: 'Half the caffeine' }, { t: 'Twice the caffeine', correct: true }, { t: 'The same caffeine' }, { t: 'No caffeine' }],
  ...
  origin: [
    { q: 'Bright, floral, tea-like, often washed. Famously from…',
      choices: [{ t: 'Brazil' }, { t: 'Ethiopia', correct: true }, { t: 'Vietnam' }, { t: 'Hawaii' }],
      explain: 'Ethiopia — coffee’s birthplace — is known for delicate, floral cups.' },
    { q: 'Balanced, nutty, chocolatey; the world’s 2nd-largest producer?',
      choices: [{ t: 'Brazil', correct: true }, { t: 'Yemen' }, { t: 'Kenya' }, { t: 'Panama' }],
      explain: 'Brazil grows huge volumes of smooth, nutty, low-acid coffee.' },
    { q: 'Which country is the largest Robusta producer?',
      choices: [{ t: 'Colombia' }, { t: 'Vietnam', correct: true }, { t: 'Kenya' }, { t: 'Guatemala' }],
  ...
  brew: [
    ...
    { q: 'Best water temperature for most pour-over?',
      choices: [{ t: '60 °C' }, { t: '~93 °C', correct: true }, { t: '100 °C, rolling boil' }, { t: '75 °C' }],
  ...
  taste: [
    { q: 'Heavy blueberry / fruity notes most often come from…',
      choices: [{ t: 'Washed process' }, { t: 'Natural process', correct: true }, { t: 'Dark roast' }, { t: 'Hard water' }],
    ...
    { q: 'The “crema” on an espresso is…',
      choices: [{ t: 'Added milk foam' }, { t: 'Emulsified oils + CO₂', correct: true }, { t: 'Burnt sugar' }, { t: 'Undissolved grounds' }],
      explain: 'Crema is a fragile emulsion of oils and gas pushed out under pressure.' },
    { q: 'Harsh bitterness most often comes from…',
      choices: [{ t: 'Under-extraction' }, { t: 'Over-extraction / dark roast', correct: true }, { t: 'Too much fruit' }, { t: 'Cold water' }],
      explain: 'Pull too much, or roast too dark, and bitterness dominates.' },
    { q: 'A sour, thin cup is usually a sign of…',
      choices: [{ t: 'Under-extraction', correct: true }, { t: 'Over-extraction' }, { t: 'Too fine a grind' }, { t: 'Too much coffee' }],
      explain: 'Sour + weak = under-extracted. Grind finer or brew hotter/longer.' },
  ],
  processing: [
    { q: 'In the washed process, the fruit is…',
      choices: [{ t: 'Left on through drying' }, { t: 'Removed before drying', correct: true }, { t: 'Never grown' }, { t: 'Roasted first' }],
    ...
    { q: 'Which process usually tastes cleanest and brightest?',
      choices: [{ t: 'Natural' }, { t: 'Washed', correct: true }, { t: 'Honey' }, { t: 'They’re identical' }],
      explain: 'Washing strips the fruit, so origin and acidity read clearly.' },
    { q: 'Take one bean, process it three ways. You get…',
      choices: [{ t: 'The same cup' }, { t: 'Three different cups', correct: true }, { t: 'Only a color change' }, { t: 'No difference' }],
