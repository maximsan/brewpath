...
// ── The 30-lesson syllabus ──────────────────────────────────
// Five modules of six. Display order is array position, NOT id order: existing
// lesson ids never move, so several modules read out of numeric sequence on
// purpose (m3 opens on m3l4; m4 runs l1, l2, l5, l3, l6, l7). Four things point
// at lesson ids — COLLECTION[].unlock.lesson, brew-challenge pointers, every
// dictionary term's `lesson`, and the mini-game source lessons — so renumbering
...
// Lessons with full card payloads. All 30 lessons across the five modules have
// a payload; the 15 added by the merged syllabus carry `draft: true` — their
// card shape is final, their prose is a working draft.
const LESSONS = {
  m1l1: {
  ...
  // ── Lessons added by the merged 30-lesson syllabus ─────────────────
  // `draft: true` marks a lesson whose SHAPE is final but whose prose is not.
  // The card kinds, order, grading and rewards are authored; the copy is a
  // working draft for the writing pass. Nothing outside data.jsx reads it.
