  ...
  m5l3: {
    ...
    cards: [
      ...
      { kind: 'concept', label: 'CONCEPT', title: 'The words for what you taste',
        ...
        paragraphs: [
          'Four words carry almost every tasting note you will read. Acidity is the bright, juicy liveliness \u2014 a good thing, and not the same as sour. Body, also called mouthfeel, is how heavy the cup sits on your tongue.',
          'Finish is what lingers after you swallow. Balance is how well all of it fits together \u2014 the word for a cup where nothing sticks out.',
        ],
  ...
  m5l7: {
    ...
    cards: [
      ...
      { kind: 'decision', label: 'AT THE MACHINE', title: 'The shot ran in eighteen seconds',
        ...
        note: 'Hold the dose and the target output steady. Move the grind, taste, repeat.' },
      { kind: 'recall', label: 'BEFORE YOU GO',
...
const COLLECTION = [
  ...
  { id: 'c-m5l5', earned: false, unlock: { lesson: 'm5l5' }, kind: 'filter', title: 'The Filter',
    ...
    fact: 'Paper traps the oils that carry body; metal lets them straight through.',
    meta: [['PAPER', 'Clean · light'], ['METAL', 'Heavy · oily']] },
  { id: 'c-m5l7', earned: false, unlock: { lesson: 'm5l7' }, kind: 'shot', title: 'The Shot',
    summary: 'Why nine bars makes a different drink out of the same coffee.',
    fact: 'Espresso is a method, not a roast: ~9 bars for ~28 seconds, 18 g in and about 36 g out.',
    meta: [['PRESSURE', '~9 bar'], ['TIME', '~28 sec']] },
