...
const DICT_TERMS = [
  ...
  { id: 'parchment', term: 'Parchment', cat: 'processing', aliases: ['parchment', 'pergamino'],
    ...
    deep: 'Also called pergamino. Once the fruit and mucilage are gone, the seed is still wrapped in this dry husk, which protects it during storage. Hulling — removing the parchment — usually happens as late as possible, just before the coffee leaves for the roaster.',
