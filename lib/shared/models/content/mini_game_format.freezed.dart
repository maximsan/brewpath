...
/// drops nothing, so the model mirrors the bank.
 String get kind; String get title;/// The lesson teaching the topic this game advertises. The tier line reads
/// it: a game is free iff this lesson is free (ADR-0007, #225).
@JsonKey(name: 'lesson') String get lessonId;@JsonKey(name: 'sub') String get topic;@JsonKey(name: 'meta') String get duration; String get blurb; List<String> get steps;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,kind,title,lessonId,topic,duration,blurb,const DeepCollectionEquality().hash(steps));

@override
String toString() {
  return 'MiniGameFormat(id: $id, kind: $kind, title: $title, lessonId: $lessonId, topic: $topic, duration: $duration, blurb: $blurb, steps: $steps)';
}
...
@useResult
$Res call({
 String id, String kind, String title,@JsonKey(name: 'lesson') String lessonId,@JsonKey(name: 'sub') String topic,@JsonKey(name: 'meta') String duration, String blurb, List<String> steps
});
...
/// Create a copy of MiniGameFormat
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? kind = null,Object? title = null,Object? lessonId = null,Object? topic = null,Object? duration = null,Object? blurb = null,Object? steps = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String kind,  String title, @JsonKey(name: 'lesson')  String lessonId, @JsonKey(name: 'sub')  String topic, @JsonKey(name: 'meta')  String duration,  String blurb,  List<String> steps)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MiniGameFormat() when $default != null:
return $default(_that.id,_that.kind,_that.title,_that.lessonId,_that.topic,_that.duration,_that.blurb,_that.steps);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String kind,  String title, @JsonKey(name: 'lesson')  String lessonId, @JsonKey(name: 'sub')  String topic, @JsonKey(name: 'meta')  String duration,  String blurb,  List<String> steps)  $default,) {final _that = this;
switch (_that) {
case _MiniGameFormat():
return $default(_that.id,_that.kind,_that.title,_that.lessonId,_that.topic,_that.duration,_that.blurb,_that.steps);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String kind,  String title, @JsonKey(name: 'lesson')  String lessonId, @JsonKey(name: 'sub')  String topic, @JsonKey(name: 'meta')  String duration,  String blurb,  List<String> steps)?  $default,) {final _that = this;
switch (_that) {
case _MiniGameFormat() when $default != null:
return $default(_that.id,_that.kind,_that.title,_that.lessonId,_that.topic,_that.duration,_that.blurb,_that.steps);case _:
  return null;
...
class _MiniGameFormat implements MiniGameFormat {
  const _MiniGameFormat({required this.id, required this.kind, required this.title, @JsonKey(name: 'lesson') required this.lessonId, @JsonKey(name: 'sub') required this.topic, @JsonKey(name: 'meta') required this.duration, required this.blurb, required final  List<String> steps}): _steps = steps;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,kind,title,lessonId,topic,duration,blurb,const DeepCollectionEquality().hash(_steps));
...
/// Create a copy of MiniGameFormat
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? kind = null,Object? title = null,Object? lessonId = null,Object? topic = null,Object? duration = null,Object? blurb = null,Object? steps = null,}) {
