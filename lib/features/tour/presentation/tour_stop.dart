...
/// here from tokens: the scrim is [OverlayColors.scrim] (the same constant the
/// rest of the app's overlays use, and deliberately mood-independent), and the
/// tooltip surface and ink come from `context.mood`, so the card flips with the
...
class TourStop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Showcase(
      ...
      // Both come from the one token, so the highlight sits under the same
      // scrim as every other overlay in the app rather than near it. The
      ...
      overlayColor: OverlayColors.scrim,
      overlayOpacity: OverlayColors.scrimOpacity,
