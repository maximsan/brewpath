...
/// The drill's copy, verbatim from `prototype/dictionary.jsx` (the banner) and
/// `prototype/dictionary-extras.jsx` (the screen) unless noted otherwise.
abstract final class TermOfDayCopy {
  ...
  /// already reading — the design's own note at `dictionary-extras.jsx:56`.
