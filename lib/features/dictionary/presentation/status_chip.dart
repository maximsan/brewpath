...
/// colour, with no chip behind it, so the name is the design's rather than a
/// pill. The two never separate because the three states differ by hue, and
/// hue is the one thing a screen reader cannot report.
class StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: status.label(context.strings),
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            status.label(context.strings).toUpperCase(),
            style: AppText.micro(
              mood: mood,
              face: AppFace.mono,
              color: colour,
