...
/// The Today card when the lesson is the learner's to open: its module, its
/// name, the module's picture, where it sits, how long it takes, and *Begin
/// lesson*.
///
/// No points on the card: the design's meta line is position and time, and
/// what finishing pays is the lesson's own to announce at the end.
