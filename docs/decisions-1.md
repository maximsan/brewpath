...
>
> ⚠️ **Four of those answers contradict [Streak and freeze](https://github.com/maximsan/brewpath/issues/17)**, a closed decision on the map. The table below is **#17's version, not this document's** — recorded so the disagreement stays visible instead of being rediscovered. Which set ships is tracked at [Streak freeze: §10 now rules nine behaviours, four of them against Streak and freeze](https://github.com/maximsan/brewpath/issues/58).
