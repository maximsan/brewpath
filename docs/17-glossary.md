...
### `part` directive
A Dart language feature that splits a library across multiple files. `part 'x.freezed.dart'` tells Dart that the generated file is part of the same library. Required for Freezed and json_serializable generated code.
