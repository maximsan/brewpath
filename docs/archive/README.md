...
| `04-folder-structure.md` | Original `lib/` folder-structure spec, written around the Isar 3.x design; the tree it prescribed drifted from the one that got built. | the repository itself |
