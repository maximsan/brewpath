...
- **Replays pay 0.** A completed lesson opens through a review-confirm sheet
  ([#573](https://github.com/maximsan/brewpath/issues/573)). The app rejected
  the second half of this bullet: a replay **does** play its ending, with its
  own eyebrow and a collapsed points line, because a run that ends on nothing
  reads as a crash. It pays no points, lifts mastery and protects the day.
