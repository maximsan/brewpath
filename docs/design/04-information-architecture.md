...
**Rewards** — `lesson-complete`, `lesson-complete-weak`, `lesson-complete-perfect`, `module-complete`, `module-card` *(harness-only — it deep-links `module-complete` already flipped; the collectible is the back of that flip)*
