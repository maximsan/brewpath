...
fails a debug build rather than guess, because the guess it used to make
painted Dark Roast tokens on a light Material page — a screen in both moods
at once. A release build falls back to the mood of the theme's own brightness.
