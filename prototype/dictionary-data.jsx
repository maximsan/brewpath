...
const DICT_TERMS = [
  ...
  { id: 'arabica', term: 'Arabica', pron: 'uh-RAB-ih-kuh', cat: 'beans',
    ...
    sources: [{ label: 'James Hoffmann — The World Atlas of Coffee' }, { label: 'SCA — Research and resources', url: 'https://sca.coffee/research' }],
  ...
  { id: 'decaf', term: 'Decaf', cat: 'processing', aliases: ['decaf', 'decaffeinated'],
    ...
    sources: [{ label: 'National Coffee Association — Decaf coffee', url: 'https://www.aboutcoffee.org/beans/decaf-coffee/' }],
  ...
  { id: 'green-coffee', term: 'Green Coffee', cat: 'processing', aliases: ['green coffee', 'green bean', 'green beans'],
    ...
    sources: [{ label: 'National Coffee Association — Lifecycle of coffee', url: 'https://www.aboutcoffee.org/origins/lifecycle-of-coffee/' }],
  ...
  { id: 'roast-level', term: 'Roast Level', cat: 'roasting', aliases: ['roast level'],
    ...
    sources: [{ label: 'SCA — Coffee Standards', url: 'https://sca.coffee/research/coffee-standards' }],
  ...
  { id: 'pour-over', term: 'Pour-Over', cat: 'brewing', aliases: ['pour-over', 'pour over'],
    ...
    sources: [{ label: 'National Coffee Association — Pour-over coffee', url: 'https://www.aboutcoffee.org/brewing/pour-over-coffee/' }],
  ...
  { id: 'cold-brew', term: 'Cold Brew', cat: 'brewing', aliases: ['cold brew', 'cold-brew'],
    ...
    sources: [{ label: 'National Coffee Association — Cold brew coffee', url: 'https://www.aboutcoffee.org/brewing/cold-brew-coffee/' }],
  ...
  { id: 'channeling', term: 'Channeling', cat: 'espresso',
    ...
    sources: [{ label: 'Barista Hustle — The Importance of Good Puck Prep', url: 'https://www.baristahustle.com/lesson/ae-3-01-the-importance-of-good-puck-prep/' }],
  ...
  { id: 'tamp', term: 'Tamp', cat: 'espresso',
    ...
    sources: [{ label: 'Barista Hustle — Current Practice in Tamping', url: 'https://www.baristahustle.com/lesson/ae-3-05-current-practice-in-tamping/' }],
  ...
  { id: 'aeropress', term: 'AeroPress', pron: 'AIR-oh-press', cat: 'equipment',
    ...
    sources: [{ label: 'Perfect Daily Grind — AeroPress: A revisited brew guide', url: 'https://perfectdailygrind.com/2025/02/aeropress-revisited-coffee-brew-guide/' }, { label: 'AeroPress — official brew guides' }, { label: 'James Hoffmann — Technique Guides' }],
  ...
  { id: 'chemex', term: 'Chemex', pron: 'KEM-ex', cat: 'equipment',
    ...
    sources: [{ label: 'CHEMEX® official brew steps', url: 'https://chemexcoffeemaker.com/pages/how-to-brew-with-chemex' }, { label: 'James Hoffmann — Technique Guides' }],
  ...
  { id: 'french-press', term: 'French Press', cat: 'equipment', aliases: ['french press', 'cafetière', 'cafetiere', 'press pot'],
    ...
    sources: [{ label: 'National Coffee Association — French press coffee', url: 'https://www.aboutcoffee.org/brewing/french-press-coffee/' }, { label: 'James Hoffmann — The World Atlas of Coffee' }],
  ...
  { id: 'sca', term: 'SCA', pron: 'S-C-A', cat: 'trade', aliases: ['sca', 'specialty coffee association'],
    ...
    sources: [{ label: 'SCA — Research and resources', url: 'https://sca.coffee/research' }],
  ...
  { id: 'specialty', term: 'Specialty Coffee', cat: 'trade', aliases: ['specialty coffee', 'specialty'],
    ...
    sources: [{ label: 'SCA — Evolving the cupping protocol and form', url: 'https://sca.coffee/sca-news/read/evolving-the-sca-cupping-protocol-and-form-an-overview-of-the-pilot-testing-process' }, { label: 'SCA — Research and resources', url: 'https://sca.coffee/research' }],
