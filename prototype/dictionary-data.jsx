...
const DICT_TERMS = [
  ...
  { id: 'cultivar', term: 'Cultivar', pron: 'KUHL-tih-var', cat: 'beans',
    ...
    check: { q: 'A cultivar is best described as…',
      ...
      explain: 'A cultivar is a specific cultivated variety — like Bourbon or Geisha.' } },
  ...
  { id: 'bourbon', term: 'Bourbon', pron: 'boor-BON', cat: 'beans', aliases: ['bourbon', 'red bourbon', 'pink bourbon'],
    ...
    sources: [{ label: 'World Coffee Research — Arabica Catalog', url: 'https://varieties.worldcoffeeresearch.org/arabica' }],
    check: { q: 'Bourbon and Typica are…',
      choices: [{ t: 'The two ancestral arabica varieties', correct: true }, { t: 'Two roast levels' }, { t: 'Two processing methods' }],
      explain: 'Almost every arabica grown today descends from one of these two lines.' } },
  ...
  { id: 'geisha', term: 'Geisha', pron: 'GAY-shuh', cat: 'beans', aliases: ['geisha', 'gesha'],
    ...
    sources: [{ label: 'World Coffee Research — Arabica Catalog', url: 'https://varieties.worldcoffeeresearch.org/arabica' }],
    check: { q: 'Geisha is best known for…',
      choices: [{ t: 'Floral, tea-like aromatics at a high price', correct: true }, { t: 'A dark, chocolatey espresso base' }, { t: 'Resisting leaf rust' }],
      explain: 'It is prized for jasmine-like florals — and it yields poorly, which is why it costs what it does.' } },
  ...
  { id: 'mucilage', term: 'Mucilage', pron: 'MYOO-sih-lij', cat: 'processing',
    ...
    check: { q: 'Mucilage is…',
      choices: [{ t: 'The papery shell around the seed' }, { t: 'A sugary gel stuck to the seed', correct: true }, { t: 'The seed’s centre crease' }],
      explain: 'It’s the honey-like gel between fruit and parchment — and how much stays on decides washed, honey or natural.' } },
  ...
  { id: 'caffeine', term: 'Caffeine', pron: 'kaf-EEN', cat: 'beans',
    ...
    deep: 'Caffeine is the plant’s built-in pesticide, and how much lands in your cup depends on species, brew and serving size. Robusta carries roughly twice arabica’s share, and a long steep plus a big glass is why cold brew often tops the chart while a small espresso sits well below a mug of drip.',
    ...
    check: { q: 'Which usually delivers the most caffeine per serving?',
      choices: [{ t: 'A single espresso' }, { t: 'A mug of drip coffee' }, { t: 'A glass of cold brew', correct: true }],
      explain: 'Cold brew’s long steep and large serving add up — often ~200 mg, double a mug of drip.' } },
  ...
  { id: 'washed', term: 'Washed Process', cat: 'processing', aliases: ['washed process', 'washed'],
    ...
    check: { q: 'Washed coffees tend to taste…',
      choices: [{ t: 'Heavy and boozy' }, { t: 'Heavier and sweeter than a natural' }, { t: 'Clean and bright', correct: true }],
  ...
  { id: 'fermentation', term: 'Fermentation', pron: 'fur-men-TAY-shun', cat: 'processing',
    ...
    check: { q: 'During fermentation, the microbes are eating…',
      choices: [{ t: 'The seed itself' }, { t: 'The sugary mucilage around the seed', correct: true }, { t: 'The caffeine' }],
      explain: 'Microbes strip the sticky fruit layer off the seed — that work, and its byproducts, shape the flavour.' } },
  ...
  { id: 'decaf', term: 'Decaf', cat: 'processing', aliases: ['decaf', 'decaffeinated'],
    ...
    check: { q: 'Decaffeination happens…',
      choices: [{ t: 'To green beans, before roasting', correct: true }, { t: 'During roasting, at high heat' }, { t: 'In the cup, by brewing shorter' }],
      explain: 'It’s a green-coffee processing step — roasting and brewing don’t remove caffeine.' } },
  ...
  { id: 'first-crack', term: 'First Crack', cat: 'roasting', aliases: ['first crack'],
    ...
    check: { q: 'First crack signals…',
      choices: [{ t: 'The start of a drinkable roast', correct: true }, { t: 'The beans are burnt' }, { t: 'Second crack is about to begin' }],
  ...
  { id: 'co2', term: 'CO₂', pron: 'C-O-two', cat: 'roasting', aliases: ['co2', 'co₂', 'carbon dioxide'],
    ...
    sources: [{ label: 'SCA — Coffee Standards', url: 'https://sca.coffee/research?page=resources' }],
    check: { q: 'A flat bloom on fresh-looking grounds usually means…',
      choices: [{ t: 'The CO₂ has already escaped', correct: true }, { t: 'The water was too hot' }, { t: 'The grind was too fine' }],
      explain: 'No bloom means no trapped CO₂ left — the coffee was roasted or ground too long ago.' } },
  ...
  { id: 'espresso', term: 'Espresso', pron: 'es-PRESS-oh', cat: 'espresso', aliases: ['espresso', 'espresso shot'],
    ...
    check: { q: 'Espresso is defined by…',
      ...
      explain: 'It’s a brewing method — pressure through finely ground coffee — not a roast or a bean.' } },
  ...
  { id: 'burr-grinder', term: 'Burr Grinder', cat: 'equipment', aliases: ['burr grinder', 'grinder', 'grinders', 'burr', 'burrs'],
    ...
    check: { q: 'Burr grinders are better because they…',
      choices: [{ t: 'Are always cheaper' }, { t: 'Grind more evenly', correct: true }, { t: 'Heat the beans less, always' }],
  ...
  { id: 'aeropress', term: 'AeroPress', pron: 'AIR-oh-press', cat: 'equipment',
    ...
    check: { q: 'Two people brew the same beans in an AeroPress, one with a valve cap fitted. Why is only one cup espresso-like?',
      choices: [{ t: 'The valve holds pressure back until it builds', correct: true }, { t: 'The valve raises the brewing temperature' }, { t: 'The valve doses more coffee into the chamber' }],
  ...
  { id: 'chemex', term: 'Chemex', pron: 'KEM-ex', cat: 'equipment',
    ...
    check: { q: 'Why do Chemex recipes ask for a coarser grind than a V60?',
      choices: [{ t: 'The thick paper drains slowly', correct: true }, { t: 'Its cone angle is steeper' }, { t: 'It holds more water at once' }],
  ...
  { id: 'sca', term: 'SCA', pron: 'S-C-A', cat: 'trade', aliases: ['sca', 'specialty coffee association'],
    ...
    check: { q: 'The SCA is…',
      choices: [{ t: 'A coffee trade body that publishes standards', correct: true }, { t: 'A brand of grinder' }, { t: 'A processing method' }],
      explain: 'It is the Specialty Coffee Association — the industry body behind the standards and the flavour wheel.' } },
